...
class CompanyRankingServiceTest extends TestCase
{
    ...
    /** @test */
    public function generateAllRankings_全期間のランキングを生成する()
    {
        // Arrange
    ...
    /** @test */
    public function generateRankingForPeriod_指定期間のランキングを生成する()
    {
        // Arrange
        $company1 = Company::factory()->create();
        $company2 = Company::factory()->create();
    ...
    /** @test */
    public function generateRankingForPeriod_同じスコアの場合同じ順位になる()
    {
        // Arrange
        $company1 = Company::factory()->create();
        $company2 = Company::factory()->create();
    ...
    /** @test */
    public function getRankingForPeriod_指定期間のランキングを取得する()
    {
        // Arrange
    ...
    /** @test */
    public function getRankingForPeriod_非アクティブ企業は除外される()
    {
        // Arrange
    ...
    /** @test */
    public function getCompanyRankings_企業の全期間ランキングを取得する()
    {
        // Arrange
        $company = Company::factory()->create();
    ...
    /** @test */
    public function getCompanyRankings_ランキングがない期間はnullを返す()
    {
        // Arrange
        $company = Company::factory()->create();
    ...
    /** @test */
    public function getTopCompaniesRankingHistory_上位企業の履歴を取得する()
    {
        // Arrange
        $company1 = Company::factory()->create();
        $company2 = Company::factory()->create();
    ...
    /** @test */
    public function getRankingStatistics_ランキング統計を取得する()
    {
        // Arrange
        $company1 = Company::factory()->create();
        $company2 = Company::factory()->create();
    ...
    /** @test */
    public function getCompanyRankingHistory_企業のランキング履歴を取得する()
    {
        // Arrange
        $company = Company::factory()->create();
    ...
    /** @test */
    public function calculatePeriodDates_期間の開始日と終了日を正しく計算する()
    {
        // Arrange
    ...
    /** @test */
    public function saveRankings_ランキングをデータベースに保存する()
    {
        // Arrange
        $company = Company::factory()->create();
    ...
    /** @test */
    public function saveRankings_既存ランキングを更新する()
    {
        // Arrange
        $company = Company::factory()->create();
    ...
    /** @test */
    public function generateRankingsConcurrently_並行処理でランキングを生成する()
    {
        // Arrange
        $company = Company::factory()->create();
    ...
    /** @test */
    public function generateRankingForPeriod_空のスコアでも正常に処理される()
    {
        // Arrange
        $this->scoreService
            ->shouldReceive('calculateAllCompaniesScore')
    ...
    /** @test */
    public function createRankings_スコア順でランキングを作成する()
    {
        // Arrange
        $company1 = Company::factory()->create();
        $company2 = Company::factory()->create();
